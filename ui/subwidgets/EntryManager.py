...
class EntryManager(QGraphicsProxyWidget):
	...
	def __init__(self, parent, entry_type, placeholder_text=" "):
		...
		self.allowed_snaps = [0, 0, 0]  # bool snap, variable snap, regular_block_snap
		if entry_type < 2:
